...
export default function Navigation() {
  ...
  const handleOrderNow = () => {
    router.push('/menu'); // Direct to menu for food ordering
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" size="sm" onClick={handleOrderNow}>
              Order Now
            </Button>
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border">
            ...
            <div className="pt-4 flex flex-col space-y-2">
              <Button variant="ghost" className="justify-start" onClick={handleOrderNow}>
                Order Now
              </Button>
